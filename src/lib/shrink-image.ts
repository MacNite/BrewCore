 ...
 * would simply fail for anybody photographing a coffee bag with a recent phone.
 *
 ...
 * a bag photo only needs to be legible. A long edge of 2048 px is plenty.
 *
 ...
 * the pathological cases - a panorama, a screenshot of a whole web page -
