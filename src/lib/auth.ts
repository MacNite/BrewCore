...
export const SESSION_COOKIE = "brewcore_session";
export const PASSWORD_CHANGE_COOKIE = "brewcore_password_change";
...
export function passwordProblem(password: string): "too-short" | "too-common" | null {
  ...
  const common = ["password", "passwort", "12345678", "qwertzuiop", "qwertyuiop", "brewcore", "letmein", "kaffee", "coffee123"];
