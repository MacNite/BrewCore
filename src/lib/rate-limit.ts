...
/**
 * Fixed-window limiter held in process memory. BrewCore is a single-container
...
export const RATE_LIMITS = {
  ...
  /* Per-account rather than per-address: bounds guessing against a single
     account however the attempts are spread across addresses. */
  loginAccount: scaled(8, 15 * 60 * 1000),
  register: scaled(5, 60 * 60 * 1000),
  export: scaled(5, 60 * 60 * 1000),
  /* Redeeming an invitation is unauthenticated and hashes a password. */
